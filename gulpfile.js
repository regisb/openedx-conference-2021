...
// This is custom
gulp.task('vendor-fontawesome-css', () => gulp.src(['node_modules/@fortawesome/fontawesome-free/css/all.min.css'])
  .pipe(gulp.dest('./dist/vendor/fontawesome/css'))
);
gulp.task('vendor-fontawesome-js', () => gulp.src(['node_modules/@fortawesome/fontawesome-free/js/all.min.js'])
  .pipe(gulp.dest('./dist/vendor/fontawesome/js'))
);
gulp.task('vendor-fontawesome-webfonts', () => gulp.src(['node_modules/@fortawesome/fontawesome-free/webfonts/*'])
  .pipe(gulp.dest('./dist/vendor/fontawesome/webfonts'))
);
gulp.task('vendor', gulp.parallel('vendor-fontawesome-css', 'vendor-fontawesome-js', 'vendor-fontawesome-webfonts'));
...
gulp.task('build', gulp.parallel('js', 'css', 'plugins', 'vendor'))
